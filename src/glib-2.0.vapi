...
namespace GLib {
	...
	public static char* convert (char* str, ssize_t len, string to_codeset, string from_codeset, out size_t bytes_read = null, out size_t bytes_written = null) throws ConvertError;
