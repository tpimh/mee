/* gee-0.8.vapi generated by valac 0.22.0, do not modify. */
...
namespace Gee {
	...
	public interface Future<G> : GLib.Object {
		...
		public virtual Gee.Future<A> light_map<A> (Gee.Future.LightMapFunc<A,G> func);
	...
	[CCode (cheader_filename = "gee.h")]
	public static Gee.Future<G> task<G> (Gee.Task<G> task) throws GLib.ThreadError;
}
